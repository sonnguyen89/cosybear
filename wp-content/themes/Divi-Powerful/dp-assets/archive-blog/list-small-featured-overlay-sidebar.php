...
?>
	...
	<div class="container free-list-small-featured-overlay-sidebar">
						...
						while ( have_posts() ) : the_post();
							...
							if($flag == 1) {
								...
								<?php if ( ! in_array( $post_format, array( 'link', 'audio', 'quote' ) ) ) : ?>
									...
									<span class="free-post-meta-category-extra"><?php echo get_the_category_list(', '); ?></span>
