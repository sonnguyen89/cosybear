...
class TitanFrameworkOptionNumber extends TitanFrameworkOption {
	...
	public function display() {
		...
		printf('<input class="%s-text" name="%s" placeholder="%s" id="%s" type="number" value="%s" min="%s" max="%s" step="%s" /> %s <p class="description">%s</p>',
			$this->settings['size'], // phpcs:ignore
			$this->getID(), // phpcs:ignore
			$this->settings['placeholder'], // phpcs:ignore
			$this->getID(), // phpcs:ignore
			esc_attr( $this->getValue() ),
			$this->settings['min'], // phpcs:ignore
			$this->settings['max'], // phpcs:ignore
			$this->settings['step'], // phpcs:ignore
			$this->settings['unit'], // phpcs:ignore
			$this->settings['desc'] // phpcs:ignore
		);
