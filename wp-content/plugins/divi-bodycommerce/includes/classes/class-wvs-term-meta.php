<?php
	...
	if ( ! class_exists( 'bodycommerce_Term_Meta' ) ):
		class bodycommerce_Term_Meta {
    ...
    <textarea name="<?php echo esc_attr( $field[ 'id' ] ) ?>" id="<?php echo esc_attr( $field[ 'id' ] ) ?>" rows="5" cols="<?php echo esc_attr( $field[ 'size' ] ) ?>" <?php echo esc_attr( $field[ 'required' ] . $field[ 'placeholder' ] ) ?>><?php echo esc_html( $field[ 'value' ] ) ?></textarea>
						...
						case 'select2':
							...
							case 'image':
								...
								<?php if ($field[ 'value' ] != ""){
									?>
													<img style="padding-bottom:20px;width: 80px;" src="<?php echo $field[ 'value' ] ?>">
														<?php }?>
	                            <input name="<?php echo $field[ 'id' ] ?>" id="<?php echo $field[ 'id' ] ?>" type="text" class="wvs-image-url" value="<?php echo $field[ 'value' ] ?>" data-default-color="<?php echo $field[ 'value' ] ?>" size="<?php echo $field[ 'size' ] ?>" <?php echo $field[ 'required' ] . $field[ 'placeholder' ] ?>>
