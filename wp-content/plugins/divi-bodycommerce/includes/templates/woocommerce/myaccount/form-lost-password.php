...
$login_page_lost_password = $titan->getOption( 'login_page_lost_password' );
/**
 * Lost password form
 *
...
<?php
	...
	$login_page_lost_password_display = '[showmodule id="'.$login_page_lost_password.'"]';
  echo do_shortcode( ''.$login_page_lost_password_display.'' );
}
