...
$get_my_acount_page_edit_account_layout = $titan->getOption( 'my_acount_page_edit_account_layout' );
/**
 * Edit account form
 *
...
if ($get_my_acount_page_edit_account_layout == 0) { ?>
...
<?php
	...
	$get_my_acount_page_edit_account_layout_display = '[showmodule id="'.$get_my_acount_page_edit_account_layout.'"]';

	echo do_shortcode( ''.$get_my_acount_page_edit_account_layout_display.'' );
