...
$my_account_orders_view_order = $titan->getOption( 'my_account_orders_view_order' );
/**
 * View Order
 *
...
if ($my_account_orders_view_order == 0) {
?>
<p><?php
...
<?php do_action( 'woocommerce_view_order', $order_id );
	...
	$my_account_orders_view_order_display = '[showmodule id="'.$my_account_orders_view_order.'"]';
	echo do_shortcode( ''.$my_account_orders_view_order_display.'' );
