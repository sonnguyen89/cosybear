...
$login_page_password_reset = $titan->getOption( 'login_page_password_reset' );
/**
...
if ($login_page_password_reset == 0) {
...
<?php
	...
	$login_page_password_reset_display = '[showmodule id="'.$login_page_password_reset.'"]';
  echo do_shortcode( ''.$login_page_password_reset_display.'' );
}
