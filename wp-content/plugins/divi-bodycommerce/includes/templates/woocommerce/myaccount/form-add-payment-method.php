...
$my_acount_page_my_payment_details_layout_add = $titan->getOption( 'my_acount_page_my_payment_details_layout_add' );
/**
...
if ($my_acount_page_my_payment_details_layout_add == 0) {
...
<?php
	...
	$my_acount_page_my_payment_details_layout_add_display = '[showmodule id="'.$my_acount_page_my_payment_details_layout_add.'"]';

	echo do_shortcode( ''.$my_acount_page_my_payment_details_layout_add_display.'' );
