...
$my_acount_page_my_payment_details_layout = $titan->getOption( 'my_acount_page_my_payment_details_layout' );
/**
 * Payment methods
 *
...
if ($my_acount_page_my_payment_details_layout == 0) {
...
<?php
	...
	$my_acount_page_my_payment_details_layout_display = '[showmodule id="'.$my_acount_page_my_payment_details_layout.'"]';

	echo do_shortcode( ''.$my_acount_page_my_payment_details_layout_display.'' );
