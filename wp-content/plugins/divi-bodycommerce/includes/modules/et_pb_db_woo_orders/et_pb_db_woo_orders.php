...
class db_woo_orders_code extends ET_Builder_Module {
...
protected $module_credits = array(
  ...
  'author_uri' => DE_DB_URL,
                ...
                function init() {
                    $this->name       = esc_html__( '.AP Orders - Account Pages', 'divi-bodyshop-woocommerce' );
                    $this->slug = 'et_pb_db_woo_orders';
		...
		$this->fields_defaults = array(
          ...
          $this->settings_modal_toggles = array(
    		...
    		return $fields;
                  ...
                  echo do_shortcode( "[db_woo_orders]" );
