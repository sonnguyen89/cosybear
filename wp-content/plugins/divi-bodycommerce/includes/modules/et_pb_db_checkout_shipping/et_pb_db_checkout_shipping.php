...
class db_woo_checkout_shipping extends ET_Builder_Module {
...
protected $module_credits = array(
  ...
  'author_uri' => DE_DB_URL,
                ...
                function init() {
                    $this->name       = esc_html__( '.CHP Shipping - Checkout Page', 'divi-bodyshop-woocommerce' );
                    $this->slug = 'et_pb_db_checkout_shipping';
          ...
          $this->settings_modal_toggles = array(
                  ...
                  function get_fields() {
                    ...
                    'admin_label' => array(
                        ...
                        '__getcheckoutshipping' => array(
                          'type' => 'computed',
                          'computed_callback' => array( 'db_woo_checkout_shipping', 'get_checkout_shipping' ),
      ...
      public static function get_checkout_shipping ( $args = array(), $conditional_tags = array(), $current_page = array() ){
        if (!is_admin()) {
          return;
        }
