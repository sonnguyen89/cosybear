...
.bodycommerce-free-badge svg {
  fill: '.$check_BodyCommerce_sale_badge_color_primary_free.';
  position: absolute;
    z-index: 100;
...
.bodycommerce-free-badge svg path.primary, .bodycommerce-free-badge svg polygon.primary {
    fill: '.$check_BodyCommerce_sale_badge_color_primary_free.' !important;
  }

.bodycommerce-free-badge svg polygon, .bodycommerce-free-badge svg circle {
    fill: '.$check_BodyCommerce_sale_badge_color_secondary_free.' !important;}
