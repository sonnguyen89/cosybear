...
$check_BodyCommerce_sale_badge_color_primary = $titan->getOption( 'BodyCommerce_sale_badge_color_primary_free' );
$check_BodyCommerce_sale_badge_color_secondary = $titan->getOption( 'BodyCommerce_sale_badge_color_secondary_free' );
$check_BodyCommerce_sale_badge_edge_distance = $titan->getOption( 'BodyCommerce_sale_badge_edge_distance_free' );
$check_BodyCommerce_sale_badge_top_distance = $titan->getOption( 'BodyCommerce_sale_badge_top_distance_free' );
$check_BodyCommerce_sale_badge_position = $titan->getOption( 'BodyCommerce_sale_badge_position_free' );
$check_BodyCommerce_sale_badge_size = $titan->getOption( 'BodyCommerce_sale_badge_size_free' );
$check_BodyCommerce_sale_badge_text_color = $titan->getOption( 'BodyCommerce_sale_badge_text_color_free' );
$check_BodyCommerce_sale_badge_text_size = $titan->getOption( 'BodyCommerce_sale_badge_text_size_free' );
$check_BodyCommerce_sale_badge_text_position = $titan->getOption( 'BodyCommerce_sale_badge_text_position_free' );
$check_BodyCommerce_sale_badge_text_line_height = $titan->getOption( 'BodyCommerce_sale_badge_text_line_height_free' );
$check_BodyCommerce_sale_badge_edge_distance_text = $titan->getOption( 'BodyCommerce_sale_badge_edge_distance_text_free' );
$check_BodyCommerce_sale_badge_top_distance_text = $titan->getOption( 'BodyCommerce_sale_badge_top_distance_text_free' );
