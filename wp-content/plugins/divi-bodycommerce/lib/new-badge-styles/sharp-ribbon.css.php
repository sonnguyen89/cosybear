...
.bodycommerce-new-badge svg {
  fill: '.$check_BodyCommerce_sale_badge_color_primary_new.';
  position: absolute;
    z-index: 100;
...
.bodycommerce-new-badge svg path.primary, .bodycommerce-new-badge svg polygon.primary {
    fill: '.$check_BodyCommerce_sale_badge_color_primary_new.' !important;
  }

.bodycommerce-new-badge svg polygon, .bodycommerce-new-badge svg circle {
    fill: '.$check_BodyCommerce_sale_badge_color_secondary_new.' !important;}
