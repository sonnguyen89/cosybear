...
$check_BodyCommerce_sale_badge_color_quaternary = $titan->getOption( 'BodyCommerce_sale_badge_color_quaternary' );
...
.bodycommerce-sale-badge svg {
  fill: '.$check_BodyCommerce_sale_badge_color_secondary.';
  position: absolute;
    z-index: 100;
...
.bodycommerce-sale-badge svg .primary {
	  fill: '.$check_BodyCommerce_sale_badge_color_primary.' !important;
}
.bodycommerce-sale-badge svg .quaternary {
	  fill: '.$check_BodyCommerce_sale_badge_color_quaternary.' !important;
}
