...
$check_BodyCommerce_sale_badge_color_primary = $titan->getOption( 'BodyCommerce_sale_badge_color_primary_ofs' );
$check_BodyCommerce_sale_badge_color_secondary = $titan->getOption( 'BodyCommerce_sale_badge_color_secondary_ofs' );
$check_BodyCommerce_sale_badge_edge_distance = $titan->getOption( 'BodyCommerce_sale_badge_edge_distance_ofs' );
$check_BodyCommerce_sale_badge_top_distance = $titan->getOption( 'BodyCommerce_sale_badge_top_distance_ofs' );
$check_BodyCommerce_sale_badge_position = $titan->getOption( 'BodyCommerce_sale_badge_position_ofs' );
$check_BodyCommerce_sale_badge_size = $titan->getOption( 'BodyCommerce_sale_badge_size_ofs' );
$check_BodyCommerce_sale_badge_text_color = $titan->getOption( 'BodyCommerce_sale_badge_text_color_ofs' );
$check_BodyCommerce_sale_badge_text_size = $titan->getOption( 'BodyCommerce_sale_badge_text_size_ofs' );
$check_BodyCommerce_sale_badge_text_position = $titan->getOption( 'BodyCommerce_sale_badge_text_position_ofs' );
$check_BodyCommerce_sale_badge_text_line_height = $titan->getOption( 'BodyCommerce_sale_badge_text_line_height_ofs' );
$check_BodyCommerce_sale_badge_edge_distance_text = $titan->getOption( 'BodyCommerce_sale_badge_edge_distance_text_ofs' );
$check_BodyCommerce_sale_badge_top_distance_text = $titan->getOption( 'BodyCommerce_sale_badge_top_distance_text_ofs' );
