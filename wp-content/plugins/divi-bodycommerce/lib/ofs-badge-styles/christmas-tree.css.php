...
$check_BodyCommerce_sale_badge_color_quaternary_ofs = $titan->getOption( 'BodyCommerce_sale_badge_color_quaternary_ofs' );
...
.bodycommerce-ofs-badge svg {
  fill: '.$check_BodyCommerce_sale_badge_color_secondary_ofs.';
  position: absolute;
    z-index: 100;
...
.bodycommerce-ofs-badge svg .primary {
	  fill: '.$check_BodyCommerce_sale_badge_color_primary_ofs.' !important;
}
.bodycommerce-ofs-badge svg .quaternary {
	  fill: '.$check_BodyCommerce_sale_badge_color_quaternary_ofs.' !important;
}
...
.bodycommerce-ofs-text {
  position: absolute;
    ...
    .bodycommerce-ofs-badge {position:absolute;
      '.$check_BodyCommerce_sale_badge_position_ofs.': '.$check_BodyCommerce_sale_badge_edge_distance_ofs.'px;
      top: '.$check_BodyCommerce_sale_badge_top_distance_ofs.'px;}
    .bodycommerce-ofs-badge svg {
      fill: '.$check_BodyCommerce_sale_badge_color_secondary_ofs.';
