...
?>
<svg style="width:<?php echo $check_cart_custom_icon_width ?>px;max-height:<?php echo $check_cart_custom_icon_width ?>px;float:left;" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 37 37" xmlns:xlink="http://www.w3.org/1999/xlink" enable-background="new 0 0 37 37">
  <g>
    <g>
