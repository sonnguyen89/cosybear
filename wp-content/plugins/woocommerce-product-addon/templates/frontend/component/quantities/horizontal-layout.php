...
//             // wp_enqueue_script('ppom-custom-dp-js', PPOM_PT_URL. '/js/ppom-pricetable.js', array('jquery'), true);

//             // $css_name = "/css/{$table_style}.css";
//             wp_enqueue_style('horizontal', '/css/horizontal.css');
// }
