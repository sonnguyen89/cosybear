<?php
/**
* Date Range Input Template
* 
* This template can be overridden by copying it to yourtheme/ppom/frontend/inputs/daterange.php
* 
* @version 1.0
**/
...
$fm = new PPOM_InputManager($field_meta, 'daterange');
