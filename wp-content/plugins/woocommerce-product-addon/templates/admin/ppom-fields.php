				...
				<div class="ppom-tabs-init ppom-admin-tabs-css">
						...
						<div class="row">
							<div class="col-md-6 col-sm-12">
								<div class="form-group">
									...
									<input type="text" class="form-control" maxlength="50" name="productmeta_name" value="<?php echo $productmeta_name?>">
								</div>
							</div>
							<div class="col-md-6 col-sm-12">
								<div class="form-group">
				    ...
				    <div class="ppom-admin-tab-content">
						<div class="row">
							...
							<div class="col-md-6 col-sm-12">
								<div class="form-group">
									<label><?php _e('Custom Javascipt', "ppom"); ?>
			                         	<span class="ppom-helper-icon" data-ppom-tooltip="ppom_tooltip" title="<?php _e('Add your own javascipt script.', "ppom")?>" ><i class="dashicons dashicons-editor-help"></i></span>
			                     	</label>
									<textarea id="ppom-js-editor" class="form-control" name="productmeta_js"><?php echo wp_unslash($productmeta_js)?></textarea>
								</div>
							</div>
						</div>
			      	</div>
	                        ...
	                        <tr class="row_no_<?php echo esc_attr($f_index); ?>" id="ppom_sort_id_<?php echo esc_attr($f_index); ?>">
                                ...
                                <td>
                                	<div class="onoffswitch">
									    <input <?php echo checked($field_status, 'on'); ?> type="checkbox" class="onoffswitch-checkbox" id="ppom-onoffswitch-<?php echo esc_attr($f_index)?>" tabindex="0">
									    <label class="onoffswitch-label" for="ppom-onoffswitch-<?php echo esc_attr($f_index)?>">
									        <span class="onoffswitch-inner"></span>
									        <span class="onoffswitch-switch"></span>
									    </label>
									    <input type="hidden" value="<?php echo $field_status; ?>" name="ppom[<?php echo esc_attr($f_index); ?>][status]">
									</div>
                                </td>
